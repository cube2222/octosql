	...
	}{
		{
			...
			args: args{
				NewInMemoryStream([]*Record{
					...
					UtilNewRecord( //repetition - different column order
					...
					UtilNewRecord( //unique - diff in numbers
						[]octosql.VariableName{"name", "numbers", "map", "number"},
						[]interface{}{"nazwa", []int{1, 3},
							map[int]string{
								0: "aaa",
								1: "bbb",
								2: "ccc"}, 7}),
					UtilNewRecord( //unique diff in number
						[]octosql.VariableName{"name", "numbers", "map", "number"},
						[]interface{}{"nazwa", []int{1, 2},
							map[int]string{
								0: "aaa",
								1: "bbb",
								2: "ccc"}, 8}),
					UtilNewRecord( //unique - diff in name
						[]octosql.VariableName{"numbers", "map", "name", "number"},
						[]interface{}{[]int{1, 2},
							map[int]string{
								0: "aaa",
								1: "bbb",
					...
					UtilNewRecord( //repetition of diff in number
						[]octosql.VariableName{"number", "numbers", "map", "name"},
						[]interface{}{8, []int{1, 2},
							map[int]string{
								0: "aaa",
								1: "bbb",
					...
					UtilNewRecord( //repetition - second row template;
						...
						[]interface{}{1, []interface{}{9, 1, 11}, 17}),
