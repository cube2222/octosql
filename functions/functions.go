...
func FunctionMap() map[string]physical.FunctionDetails {
	return map[string]physical.FunctionDetails{
		...
		// 			OutputType:    octosql.Boolean,
		// 			Strict:        true,
		// 			Function: func() func(ctx execution.ExecutionContext, values [][]octosql.Value) ([]octosql.Value, error) {
		...
		// 				}
		//
		// 				return func(ctx execution.ExecutionContext, values [][]octosql.Value) ([]octosql.Value, error) {
		// 					const likeEscape = '\\'
		// 					const likeAny = '_'
		// 					const likeAll = '%'
		//
