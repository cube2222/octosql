...
type RunRequest struct {
	Predicate      *Expression       `protobuf:"bytes,1,opt,name=predicate,proto3" json:"predicate,omitempty"`
	VariableValues map[string]*Value `protobuf:"bytes,2,rep,name=variable_values,json=variableValues,proto3" json:"variable_values,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type TypeAssertion struct {
	Argument   *Expression `protobuf:"bytes,1,opt,name=argument,proto3" json:"argument,omitempty"`
...
func (m *TypeAssertion) GetArgument() *Expression {
	if m != nil {
		return m.Argument
	}
	return nil
...
type Value_Time struct {
	Time *types.Timestamp `protobuf:"bytes,6,opt,name=time,proto3,oneof"`
}
type Value_Duration struct {
	Duration *types.Duration `protobuf:"bytes,7,opt,name=duration,proto3,oneof"`
}
type Value_List struct {
	List *Values `protobuf:"bytes,8,opt,name=list,proto3,oneof"`
}
type Value_FieldValues struct {
	FieldValues *Values `protobuf:"bytes,9,opt,name=field_values,json=fieldValues,proto3,oneof"`
}
...
func _Value_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 3: // value.float
		...
		m.Value = &Value_Float{math.Float32frombits(uint32(x))}
		return true, err
	case 4: // value.bool
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
...
var fileDescriptor_a41a6b6d08976c8c = []byte{
	...
	,
}
...
func (m *Value) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			iNdEx += 4
			m.Value = &Value_Float{float32(math.Float32frombits(v))}
		case 4:
			if wireType != 0 {
