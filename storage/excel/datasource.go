...
func (ds *DataSource) Get(ctx context2.Context, variables octosql.Variables) (execution.RecordStream, error) {
...
func (rs *RecordStream) Next(context2.Context) (*execution.Record, error) {
	if rs.isDone {
